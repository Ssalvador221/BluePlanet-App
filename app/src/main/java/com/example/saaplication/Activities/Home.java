...
import com.example.saaplication.Coments.PostAdapter;
...
public class Home extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getSupportFragmentManager().beginTransaction().replace(R.id.container,new ).commit();
    ...
    private void addPost(PostAdapter post) {
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.nav_home) {
            ...
            startActivity(new Intent(Home.this, ProfileScrenPage1.class));
