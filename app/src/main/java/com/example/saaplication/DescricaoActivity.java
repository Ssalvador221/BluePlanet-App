...
public class DescricaoActivity  extends AppCompatActivity {
            ...
            firebaseFirestore.collection("Posts").document(blog_post_id).get().addOnCompleteListener(new OnCompleteListener<DocumentSnapshot>() {
                ...
                public void onComplete(@NonNull Task<DocumentSnapshot> task) {
                    if(task.isSuccessful()){
                        ...
                        Toast.makeText(DescricaoActivity.this,error,Toast.LENGTH_LONG).show();
                    }
                }
            });
    ...
    private void setBlogPost(String title, String desc, String imageurl) {
        ...
        Glide.with(DescricaoActivity.this).applyDefaultRequestOptions(placeholderOption).load(imageurl).into(descActivityImage);
    }
}